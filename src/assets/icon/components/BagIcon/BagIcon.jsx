...
const BagIcon = () => {
    ...
    return (
        <svg className={styles.bag} onClick={() => ctx.onToggleRoute('orders')} strokeWidth="0" stroke="currentColor" fill="currentColor" viewBox="0 0 16 16" id="hand-bag" height=".4em"
